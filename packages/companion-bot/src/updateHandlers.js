...
export class UpdateHandlers {
  ...
  /**
   * Установка обработчика companion-bot
   * @param {CompanionHandler} handler - Экземпляр обработчика
   */
  static setCompanionHandler(handler) {
    this.companionHandler = handler;
  }
